...
urlpatterns = [
    ...
    path('update-department/<pk>/', UpdateDepartmentView.as_view(), name='update-department'),
    path('delete-department/<pk>/', DeleteDepartmentView.as_view(), name='delete-department'),
