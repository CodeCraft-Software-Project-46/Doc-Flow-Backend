...
urlpatterns = [
    ...
    path("widgets/role-permissions/", RolePermissionsView.as_view()),
    path("widgets/task-instances/", TaskInstancesListView.as_view()),
    ...
    path("tasks/pending/", PendingTasksView.as_view()),
    path("tasks/<int:task_id>/complete/", CompleteTaskView.as_view()),
]